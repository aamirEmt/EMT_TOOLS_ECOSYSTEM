    ...
    def get_metadata(self) -> ToolMetadata:
        return ToolMetadata(
            ...
            description=(
                ...
                "IMPORTANT: Children and infants CANNOT travel alone. At least 1 adult is REQUIRED when children or infants are present. "
                "If the user requests travel for only children/infants without mentioning any adult, do NOT call this tool. "
                "Instead, ask the user to confirm how many adults will be travelling. "
                "Example: 'search a flight from delhi to mumbai on 15 april for 1 child' — do NOT search, "
                "ask the user 'Children cannot travel alone. How many adults will be accompanying the child?'\n"
