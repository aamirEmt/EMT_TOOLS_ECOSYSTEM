...
class GetHotelBookingsTool(BaseTool):
    ...
    def get_metadata(self) -> ToolMetadata:
        return ToolMetadata(
            ...
            description="Fetch all hotel bookings (Upcoming, Completed, Cancelled, Pending) for the user. The user is automatically logged in using their phone number or email.",
