...
class GetTrainBookingsTool(BaseTool):
    ...
    description="Fetch all train bookings for the user. The user is automatically logged in using their phone number or email. NEVER ASK FOR PNR, ALWAYS ASK FOR EMT BOOKING ID.",
