...
def fetch_train_availability_sync(
    train_number: str,
    from_station_code: str,
    to_station_code: str,
    classes: List[str],
    ...
    """
    Synchronous wrapper for fetch_train_availability.
    ...
    Example:
        >>> result = fetch_train_availability_sync(
        ...     train_number="12301",
        ...     from_station_code="NDLS",
        ...     to_station_code="HWH",
        ...     classes=["SL", "3A", "2A"],
        ...     journey_date="15/02/2026",
        ...     quota="GN"
        ... )
        >>> # result will be:
        >>> # {
        >>> #     "train_number": "12301",
        >>> #     "classes": [
        >>> #         {"class_code": "SL", "availability_status": "AVAILABLE 120", "fare": "755", "fare_updated": "2 hours ago"},
        >>> #         {"class_code": "3A", "availability_status": "WL 5", "fare": "1985", "fare_updated": "2 hours ago"},
        >>> #         {"class_code": "2A", "availability_status": "RAC 3", "fare": "2875", "fare_updated": "2 hours ago"},
        >>> #     ]
        >>> # }
    """
    return asyncio.run(
